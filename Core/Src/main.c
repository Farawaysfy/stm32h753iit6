...
#define Light_Gate1 HAL_GPIO_ReadPin(GPIOG,GPIO_PIN_3) //Light_Gate1  PG3（光电门1信号）
#define Light_Gate2 HAL_GPIO_ReadPin(GPIOG,GPIO_PIN_4) //Light_Gate2  PG4（光电门2信号）
